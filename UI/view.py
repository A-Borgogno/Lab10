...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddStato = ft.Dropdown(label="Selezionare lo stato di partenza")
        self._btnRaggiungibili = ft.CupertinoButton(text="Stati raggiungibili", disabled=True, on_click=self._controller.handleRaggiungibili)
